...
#define RT_APP_PART_ADDR            (0x00010000)//app partition begin address
...
{                                        \
    ...
    {FAL_PART_MAGIC_WROD, "app", "onchip_flash_hp1", 0, (BSP_ROM_SIZE_BYTES - BSP_FEATURE_FLASH_HP_CF_REGION0_SIZE)/2, 0}, \
    {FAL_PART_MAGIC_WROD, "download", "onchip_flash_hp1", (BSP_ROM_SIZE_BYTES - BSP_FEATURE_FLASH_HP_CF_REGION0_SIZE)/2, (BSP_ROM_SIZE_BYTES - BSP_FEATURE_FLASH_HP_CF_REGION0_SIZE), 0}, \
}
